...
if __name__ == "__main__":
	...
	newline2 = "file:/cms/xaastorage/NanoAOD/2018/JUNE19/UL/GJetsHTBinned/600toInf/jetToolbox_nano_mc_2018GJetsHT600toInf_"+str(process)+".root"
