...
if __name__ == "__main__":
	...
	newline2 = "file:/cms/xaastorage/NanoAOD/2018/JUNE19/UL/GJetsHTBinned/100to200/jetToolbox_nano_mc_2018GJetsHT100to200_"+str(process)+".root"
